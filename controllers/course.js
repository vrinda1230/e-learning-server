...
export const uploadVideo = async (req,res)=>{
    try{
        ...
        const params ={
            Bucket: "edemy-bucket-virgo",
            Key: `${uniqueId}.${video.type.split("/")[1]}`, //video/mp4 value
...
export const updateLesson = async (req, res)=>{
    ...
    // console.log('course.instructor._id != req.user._id', course.instructor._id != req.auth._id);
    // return;
...
export const checkEnrollment = async (req, res) =>{
    ...
    //check if courseId is found in user courses array
    let ids =[];
...
export const freeEnrollment = async (req,res) =>{
    try{
        //check if course id free or paid
...
//         success_url: `${process.env.STRIPE_SUCCESSFUL_URL}/${course._id}`,
